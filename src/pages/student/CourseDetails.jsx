...
const{allCourses,calculateRating,calculateNoOfLectures,calculateChapterTime,caluclateCourseDuration}=useContext(AppContext)
 ...
 <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
  ...
  {[...Array(5)].map((_, i) => (
    ...
    <p>{courseData.enrolledStudents.length} {courseData.enrolledStudents.length > 1? 'students' :'student'}</p>
     ...
     <p className='text-sm'>Course by <span className='text-blue-600 underline'>LearnSpark</span></p>
