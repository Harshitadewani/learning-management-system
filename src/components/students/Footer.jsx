...
const Footer = () => {
  return (
   <footer className='bg-gray-600 md:px-36 text-left w-full mt-10'>
    ...
    <div className='flex flex-col md:flex-row items-start px-8 md:px-0 justify-center gap-10 md:gap-32 py-10 border-b border-white/30'>
       ...
       <div className='flec flex-col md:items-start items-center w-full'>
       ...
       <div className='hidden md:flex flex-col items-start w-full'>
        ...
        <div className='flex items-center gap-2 pt-4'>
          ...
          <button className='bg-blue-200 w-24 h-9 text-white rounded'>Subscribe</button>
        </div>

       </div>

    </div>
    <p className='py-4 text-center text-xs md:text-sm text-white/60'>Copyright 2025 © LearnSpark.All Right Reserved </p>
